 ...
 *
 * Forbidden zone format matches MATLAB 32x5 matrix:
 ...
 *   ┌──────────────────────────────────────────────────────────────┐
 *   │  INPUTS:                                                     │
 *   │    Port 1: forbidden[32x5]  (valid,az_min,el_min,           │
 ...
 *   │    Port 2: graph_naz[256]   (node AZ coords)               │
 *   │    Port 3: graph_nel[256]   (node EL coords)               │
 *   │    Port 4: graph_adj[256x32](adjacency bytes)              │
 *   └──────────────────────────────────────────────────────────────┘
 *
 ...
 * ================================================================ */
#define AVD_MAX_FORBIDDEN      32      /* max forbidden rectangles          */
...
#define AVD_MAX_GRAPH_NODES    (AVD_MAX_FIXED_NODES + 2)  /* +start +goal = 258 */
...
typedef struct {
    ...
    AvdRect   forbidden[AVD_MAX_FORBIDDEN];          /* forbidden zones (32x5)*/
} AvdInput;
 ...
 *   A* is the primary planner; direct-path shortcut when clear.
 */
